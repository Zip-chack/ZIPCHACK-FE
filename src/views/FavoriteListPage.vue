<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div v-if="favoriteListings.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <ListingCard
    ...
    <div v-else class="text-center py-16">
      ...
      <h2 class="text-xl font-semibold text-gray-900 mb-2">찜한 매물이 없습니다</h2>
